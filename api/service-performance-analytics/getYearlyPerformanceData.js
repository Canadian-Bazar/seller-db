import { ServiceYearlyPerformance } from '../models/service-performance-analytics.schema.js';
import moment from 'moment';

const getYearlyPerformanceData = async (serviceIds, fromDate, toDate, type = 'viewCount') => {
